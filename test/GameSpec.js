...
describe('chickencoop.endBuild function', function() {
  ...
  it('must append to Game.buildings Game.chickencoop.selected and unset Game.chickencoop.selected', function() {
    // Arrange
...
describe('chickencoop.placeFloor function', function() {
  ...
  it('must call Floors.appendToDOM', function() {
    // Arrange
    var x = 0;
    var y = 0;
...
describe('chickencoop.placeHen function', function() {
  ...
  it('must call Animals.createSprite', function() {
    // Arrange
    var x = 0;
    var y = 0;
    var chickencoop = {};
